...
set g4version="geant4.9.4.p02-openGL"
...
set g4data=/data/users/jtemple/SarahGeant/geant/data/
...
#  setenv XERCESCROOT   $XercesC/$XercesCversion/${os}-opt
  ...
  setenv G4LEDATA $g4data/G4EMLOW6.19
  setenv G4NEUTRONHPDATA $g4data/G4NDL3.14
  setenv G4LEVELGAMMADATA $g4data/PhotonEvaporation2.1
  setenv G4RADIOACTIVEDATA $g4data/RadioactiveDecay3.3
  setenv G4ELASTICDATA $g4data/G4ELASTIC
  setenv G4REALSURFACEDATA $g4data/RealSurface1.0
  setenv G4NEUTRONXSDATA $g4data/G4NEUTRONXS1.0
  setenv G4PIIDATA $g4data/G4PII1.2
