...
echo "run: fcalor03 $PARAMETER_SET > $FINAL_LOG 2>&1"
#echo $HOME
export HOME=/home/pedrok
source /home/pedrok/sim/setup.sh
source /home/pedrok/sim/setup_hepmc.sh
source /home/pedrok/sim/setup_geant_opengl.sh
if [ -f $PREFIX_NAME.sh ]; then
source $PREFIX_NAME.sh
fi
#echo $G4WORKDIR
$G4BIN/Linux-g++/fcalor $PARAMETER_SET >> $FINAL_LOG 2>&1
exitcode=$?
