...
> ${FILE}_${ENERGY}_lay${LAYERS}.in

cat ./G4check.jdl \
| sed -e s/PREFIX_NAME/${FILE}/ \
| sed -e s~RUN_DIR~/home/pedrok/CMSSW_4_2_8/src/ForwardCaloUpgrade/GEANT-00_03_00~ \
| sed -e s/INPUT_NAME/${FILE}_${ENERGY}_lay${LAYERS}.in/ \
> G4_${FILE}_${ENERGY}_lay${LAYERS}.jdl

condor_submit G4_${FILE}_${ENERGY}_lay${LAYERS}.jdl
