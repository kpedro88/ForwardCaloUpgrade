...
for ENERGY in 20 30 50
  do
    ./G4tempE.sh whcal_only whcal_only_elec_temp.in ${ENERGY}
    ./G4tempE.sh wlyso_whcal_e wlyso_whcal_elec_temp.in ${ENERGY}
    ./G4tempE.sh wlyso_whcal_pi wlyso_whcal_pion_temp.in ${ENERGY}
  done
